...
(define_attr "type"
  "unknown,branch,jump,call,load,fpload,fpidxload,store,fpstore,fpidxstore,prefetch,prefetchx,condmove,xfer,mthilo,mfhilo,const,arith,shift,slt,clz,trap,imul,imul3,imadd,idiv,fmove,fadd,fmul,fmadd,fdiv,frdiv,frdiv1,frdiv2,fabs,fneg,fcmp,fcvt,fsqrt,frsqrt,frsqrt1,frsqrt2,multi,nop,pop"
...
(define_attr "cpu"
  "r3000,4kc,4kp,5kc,5kf,20kc,24k,24kx,m4k,r3900,r6000,r4000,r4100,r4111,r4120,r4130,r4300,r4600,r4650,r5000,r5400,r5500,r7000,r8000,r9000,sb1,sr71000,mips64r2_cpu,octeon"
...
(define_insn "*ashiftrt_trunc_exts"
  [(set (match_operand:SI 0 "register_operand" "=d")
        (truncate:SI
	 (ashiftrt:DI (match_operand:DI 1 "register_operand" "d")
		      (match_operand:DI 2 "const_arith_operand" ""))))]
...
(define_insn "*lshiftrt_trunc_exts"
  [(set (match_operand:SI 0 "register_operand" "=d")
        (truncate:SI
...
(define_insn "*trunc<mode>_zextdi"
  [(set (match_operand:DI 0 "register_operand" "=d")
        (zero_extend:DI (truncate:SHORT
                         (match_operand:DI 1 "register_operand" "d"))))]
  "TARGET_64BIT && !TARGET_MIPS16"
  "andi\t%0,%1,<mask>"
  [(set_attr "type"     "arith")
...
(define_insn_and_split "*zero_extendsidi2"
  ...
  "TARGET_64BIT && !ISA_HAS_DEXT_DINS"
  "@
   #
   lwu\t%0,%1"
  ...
  "!TARGET_MIPS16"
{
  if (mips_expand_unaligned_load (operands[0], operands[1],
				  ...
				  INTVAL (operands[3])))
    DONE;
  else if (register_operand (operands[1], VOIDmode)
...
(define_insn "*extzv_truncdisi_exts"
  [(set (match_operand:SI 0 "register_operand" "=d")
        (truncate:SI
	 (zero_extract:DI (match_operand:DI 1 "register_operand" "d")
			  (match_operand 2 "immediate_operand" "I")
			  (match_operand 3 "immediate_operand" "I"))))]
  "ISA_HAS_EXTS && TARGET_64BIT && INTVAL (operands[2]) >= 32"
  "exts\t%0,%1,%3,31"
  [(set_attr "type"     "shift")
   (set_attr "mode"     "SI")])
  ...
  "!TARGET_MIPS16"
{
  if (mips_expand_unaligned_store (operands[0], operands[3],
    ...
    DONE;
	   ...
	   /* store_bit_field can call us with (subreg:DI (reg:SI)).
	      When changing the sign-bit we would create incorrect SI
	      values.  */
	   && (GET_MODE (operands[0]) != DImode
	       || !(GET_CODE (operands[0]) == SUBREG
		    && (GET_MODE_SIZE (GET_MODE (SUBREG_REG (operands[0])))
...
;; SI values don't have to be properly sign-extended for dins to work.

(define_insn "*trunc_insvdi"
  [(set (zero_extract:DI (match_operand:DI 0 "register_operand" "+d")
                         (match_operand 1 "immediate_operand" "I")
                         (match_operand 2 "immediate_operand" "I"))
        (subreg:DI
	 (truncate:SI (match_operand:DI 3 "register_operand" "d")) 0))]
  "TARGET_64BIT && ISA_HAS_DEXT_DINS"
  "dins\t%0,%3,%2,%1"
  [(set_attr "type"     "shift")
   (set_attr "mode"     "DI")])
...
(define_insn "*cins"
  ...
  "ISA_HAS_CINS && mask_low_and_shift_p (operands[3], operands[2], 32)"
{
  operands[3] = GEN_INT (mask_low_and_shift_len (operands[3], operands[2]));
  return "cins\t%0,%1,%2,%E3";
}
  [(set_attr "type"     "shift")
   (set_attr "mode"     "DI")])
...
(define_insn "*seq_<mode>_seq"
  [(set (match_operand:GPR 0 "register_operand" "=d,d")
	(eq:GPR (match_operand:GPR 1 "register_operand" "%d,d")
		(match_operand:GPR 2 "reg_imm10_operand" "d,I")))]
  "ISA_HAS_SEQ_SNE"
  "@
   seq\t%0,%1,%2
   seqi\t%0,%1,%2"
...
(define_insn "*sne_<mode>_sne"
  [(set (match_operand:GPR 0 "register_operand" "=d,d")
	(ne:GPR (match_operand:GPR 1 "register_operand" "%d,d")
		(match_operand:GPR 2 "reg_imm10_operand" "d,I")))]
  "ISA_HAS_SEQ_SNE"
  "@
   sne\t%0,%1,%2
  ...
  "HAVE_AS_TLS && !TARGET_MIPS16"
{
  ...
  if (TARGET_OCTEON)
    ...
    return ".set\tpush\;.set\tmips32r2\t\;rdhwr\t%0,$29\;.set\tpop";
}
  [(set_attr "type" "unknown")
   (set_attr "mode" "<MODE>")])

