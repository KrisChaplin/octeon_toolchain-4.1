...
static int debug_to_insert_mc_hw_breakpoint (struct bp_target_info *, int);

static int debug_to_remove_mc_hw_breakpoint (struct bp_target_info *, int);
...
#define de_fault(field, value) \
  ...
  de_fault (to_insert_mc_hw_breakpoint,
	    (int (*) (struct bp_target_info *, int core_number))
	    return_minus_one);
...
static int
debug_to_insert_mc_hw_breakpoint (struct bp_target_info *bp_tgt, int core_number)
{
  int retval;

  retval = debug_target.to_insert_mc_hw_breakpoint (bp_tgt, core_number);
...
static int
debug_to_remove_mc_hw_breakpoint (struct bp_target_info *bp_tgt, int core_number)
{
  int retval;

  retval = debug_target.to_remove_mc_hw_breakpoint (bp_tgt, core_number);
