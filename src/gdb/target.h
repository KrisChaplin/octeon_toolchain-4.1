...
struct target_ops
  {
    ...
    int (*to_insert_mc_hw_breakpoint) (struct bp_target_info *, int);
    int (*to_remove_mc_hw_breakpoint) (struct bp_target_info *, int);
...
#define target_insert_mc_hw_breakpoint(bp_tgt, core_number) 		     \
     ((*current_target.to_multicore_hw_breakpoint)()  		    	     \
	? (*current_target.to_insert_mc_hw_breakpoint) (bp_tgt, core_number) \
        : (*current_target.to_insert_hw_breakpoint) (bp_tgt))

#define target_remove_mc_hw_breakpoint(bp_tgt, core_number) 		     \
     ((*current_target.to_multicore_hw_breakpoint) ()			     \
        ? (*current_target.to_remove_mc_hw_breakpoint) (bp_tgt, core_number) \
        : (*current_target.to_remove_hw_breakpoint) (bp_tgt))
#endif
