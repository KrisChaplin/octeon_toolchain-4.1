    ...
    case bfd_target_elf_flavour:
      ...
      return (target_big_endian
		 ...
		 : (mips_opts.arch == CPU_OCTEON
		    ? (HAVE_NEWABI ? "elf32-ntradbigmips" : "elf32-bigmips")
		    : (HAVE_NEWABI ? "elf32-nbigmips" : "elf32-bigmips")))
	      : (HAVE_64BIT_OBJECTS
		 ? "elf64-littlemips"
		 : (mips_opts.arch == CPU_OCTEON
		    ? (HAVE_NEWABI ? "elf32-ntradlittlemips" : "elf32-littlemips")
		    : (HAVE_NEWABI ? "elf32-nlittlemips" : "elf32-littlemips"))));
#endif
    default:
      abort ();
      return NULL;
...
#define OPTION_MOCTEON_UNSUPPORTED (OPTION_MISC_BASE + 27)
#define OPTION_NO_MOCTEON_UNSUPPORTED (OPTION_MISC_BASE + 28)
...
#define OPTION_MOCTEON_USEUN (OPTION_MISC_BASE + 29)
#define OPTION_NO_MOCTEON_USEUN (OPTION_MISC_BASE + 30)
