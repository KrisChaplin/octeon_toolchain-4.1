...
#ifdef __mips64
/* Add 64-bit definitions {__syscall,__libc_}pread*.  */
static inline _syscall4(ssize_t, __syscall_pread, int, fd, void *, buf,
...
#ifdef __mips64
/* Add 64-bit definitions {__syscall,__libc_}pwrite*.  */
static inline _syscall4(ssize_t, __syscall_pwrite, int, fd, const void *,
...
#if defined __UCLIBC_HAS_LFS__ 
ssize_t __libc_pwrite64 (int fd, const void *buf, size_t count,
			 off64_t offset)
{ 
  return __syscall_pwrite (fd, buf, count, offset);
}
